...
```
    ...
    ##  [1] "Minimal"              "Solid"                "Curved"              
    ##  [4] "BioPAX"               "Gradient1"            "Ripple"              
    ##  [7] "Big Labels"           "Sample3"              "Sample1"             
    ## [10] "Universe"             "Marquee"              "default"             
    ## [13] "BioPAX_SIF"           "default black"        "Nested Network Style"
    ## [16] "Directed"             "Sample2"              "size_rank"
...
```
    ...
    ## IGRAPH 2e26715 UNW- 845 1544 -- 
    ## + attr: name (v/c), weight (e/n)
    ## + edges from 2e26715 (vertex names):
...
![](lecture_17_walkthrough_files/figure-markdown_github/unnamed-chunk-15-1.png)
...
```
    ...
    ## + 845/845 vertices, named, from 2e26715:
...
```
    ...
    ## + 1544/1544 edges from 2e26715 (vertex names):
    ##  [1] ph_1061 --AACY020068177 ph_1258 --AACY020207233
    ##  [3] ph_3164 --AACY020207233 ph_1033 --AACY020255495
    ##  [5] ph_10996--AACY020255495 ph_11038--AACY020255495
    ##  [7] ph_11040--AACY020255495 ph_11048--AACY020255495
...
![](lecture_17_walkthrough_files/figure-markdown_github/unnamed-chunk-19-1.png)
...
![](lecture_17_walkthrough_files/figure-markdown_github/unnamed-chunk-22-1.png)
...
![](lecture_17_walkthrough_files/figure-markdown_github/unnamed-chunk-26-1.png)
